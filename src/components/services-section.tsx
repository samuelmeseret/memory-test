...
const services = [
  {
    ...
    description: "Upload photos, add relationships, and write notes for every family member.",
  },
  {
    icon: Camera,
    title: "Fast Recognition",
    description: "Instant facial recognition using the latest AI models directly from your camera.",
  },
  {
    icon: Shield,
    title: "Private & Secure",
    description: "Your data is encrypted and private. We never share your photos with third parties.",
  },
]
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A complete platform to manage your memories and profiles from A to Z.
          </p>
        </div>
