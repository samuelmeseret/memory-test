...
const defaultTopProperties = [
  { page: "John Doe", visitors: 245 },
  { page: "Jane Smith", visitors: 189 },
  { page: "Robert Johnson", visitors: 156 },
  { page: "Emily Davis", visitors: 98 },
]
...
export function RealtimePropertyCard() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-sm opacity-80">Active Scans</p>
          </div>
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-sm opacity-80">Faces Recognized</p>
          </div>
          <AnimatePresence mode="wait">
            <motion.p
              key={pageViews}
      ...
      <div>
        <p className="mb-3 text-sm font-medium text-slate-700">Most Recognized</p>
